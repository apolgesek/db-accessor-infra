...
export function sharedParamNames(stage: string): SharedParamNames {
  return {
    ...
    frontendBucketName: `/db-accessor-ui-${stage}/static-site/bucket-name`,
    frontendBucketRegionalDomainName: `/db-accessor-ui-${stage}/static-site/bucket-regional-domain-name`,
